...
// see BoondPage.jsx's onComplete.
export default function Loader({ onComplete }) {
  ...
  return (
    <div
      ...
      style={{ background: 'var(--foam)', color: 'var(--asphalt)' }}
    >
      <div className="text-[clamp(24px,4vw,34px)] tracking-[0.02em] font-black">Boond</div>
      <div className="w-[200px] h-[1px] relative overflow-hidden" style={{ background: 'rgba(22,25,28,.15)' }}>
        <div ref={barRef} className="absolute left-0 top-0 bottom-0 w-0" style={{ background: 'var(--bead)' }} />
      </div>
