...
import { PHONE_DISPLAY, WHATSAPP_NUMBER, studio } from '../content';
...
// CTAs, so this stays mobile-only; BoondPage.jsx reserves the matching space
// at the bottom of the page so it never covers the last section. Ported from
// Kavach's own ActionBar -- Boond has one studio, not a locator list, so it
// points straight at that instead of `studios[0]`.
export default function ActionBar() {
  const directionsUrl = `https://www.google.com/maps/dir/?api=1&destination=${studio.pos.join(',')}`;
